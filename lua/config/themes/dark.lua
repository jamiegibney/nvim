...
function M.set_dark_theme()
    ...
    io.stdout:write(("\027]11;#%06x\027\\"):format(1052688))
    ...
    set_hl("cPreCondit",                           { link = "@constant.macro" })
    ...
    set_hl("Normal",                               { fg = "#bababa", bg = "#101010", })
    ...
    set_hl("FloatNormal",                          { bg = "#222222", })
    set_hl("PMenu",                                { fg = "none",    bg = "#222222", })
