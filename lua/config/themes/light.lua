...
local function set_cpp_highlights()
    ...
    api.nvim_set_hl(0, "cppString", { fg = "#0a8521", italic = false, })
...
local function set_highlights()
    ...
    api.nvim_set_hl(0, "Comment", { fg = "#9c9c9c", italic = false })
    ...
    -- literals
    api.nvim_set_hl(0, "String", { fg = "#0f8f21", italic = false, })
    ...
    api.nvim_set_hl(0, "cString", { fg = "#0a8521", italic = false, })
    ...
    api.nvim_set_hl(0, "luaString", { fg = "#0a8521", italic = false, })
...
function M.set_theme()
    ...
    vim.api.nvim_set_hl(0, "BlueComment",   { fg = "#008dde", bg = "#c0ddef", italic = false, bold = true })
    vim.api.nvim_set_hl(0, "YellowComment", { fg = "#d9aa0d", bg = "#f7fab7", italic = false, bold = true })
    vim.api.nvim_set_hl(0, "RedComment",    { fg = "#d95716", bg = "#ffeeee", italic = false, bold = true })
    vim.api.nvim_set_hl(0, "PurpleComment", { fg = "#bb61e8", bg = "#f7e3fc", italic = false, bold = true })
    vim.api.nvim_set_hl(0, "GreenComment",  { fg = "#4dbb20", bg = "#e3f7de", italic = false, bold = true })
    vim.api.nvim_set_hl(0, "GreenUnderlinedComment",  { fg = "#4dbb20", bg = "#e3f7de", italic = false, bold = true, underline = true })
